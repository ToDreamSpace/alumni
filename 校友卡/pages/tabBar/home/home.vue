	...
	data() {
		return {
			...
			categoryList: [
				...
				{ id: 2, name: '**', img: '/static/img/category/2.png' },
				{ id: 3, name: '**', img: '/static/img/category/3.png' },
				{ id: 4, name: '**', img: '/static/img/category/4.png' },
				{ id: 5, name: '**', img: '/static/img/category/5.png' },
				{ id: 6, name: '**', img: '/static/img/category/6.png' },
				{ id: 7, name: '**', img: '/static/img/category/7.png' },
				{ id: 8, name: '**', img: '/static/img/category/8.png' }
			],
			Promotion: [],
			//猜你喜欢列表
			productList: [
